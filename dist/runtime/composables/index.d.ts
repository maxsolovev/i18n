 ...
 * @public
 */
export type RouteBaseNameFunction = <Name extends keyof RouteMapI18n = keyof RouteMapI18n>(route: Name | (Omit<RouteLocationAsRelativeI18n, 'path'> & {
    path?: string;
}), 
/**
 ...
 * @public
 */
export type LocalePathFunction = <Name extends keyof RouteMapI18n = keyof RouteMapI18n>(route: Name | (Omit<RouteLocationAsRelativeI18n, 'path'> & {
    path?: string;
}), 
/**
 * Note: disabled route path string autocompletion, this can break depending on `strategy`
 ...
 * @public
 */
export type LocaleRouteFunction = <Name extends keyof RouteMapI18n = keyof RouteMapI18n>(route: Name | (Omit<RouteLocationAsRelativeI18n, 'path'> & {
    path?: string;
}), 
/**
 * Note: disabled route path string autocompletion, this can break depending on `strategy`
 ...
 * @public
 */
export type LocaleLocationFunction = <Name extends keyof RouteMapI18n = keyof RouteMapI18n>(route: Name | (Omit<RouteLocationAsRelativeI18n, 'path'> & {
    path?: string;
}), 
/**
 * Note: disabled route path string autocompletion, this can break depending on `strategy`
