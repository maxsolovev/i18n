...
export declare const STRATEGY_PREFIX = "prefix";
export declare const STRATEGY_PREFIX_EXCEPT_DEFAULT = "prefix_except_default";
export declare const STRATEGY_PREFIX_AND_DEFAULT = "prefix_and_default";
export declare const STRATEGY_NO_PREFIX = "no_prefix";
...
export interface BundleOptions extends Pick<PluginOptions, 'compositionOnly' | 'runtimeOnly' | 'fullInstall' | 'dropMessageCompiler' | 'onlyLocales'> {
}
...
export type NuxtI18nOptions<Context = unknown, ConfiguredLocaleType extends string[] | LocaleObject[] = string[] | LocaleObject[]> = {
    /**
...
export type VueI18nConfig = () => Promise<{
